...
func (_m *MockReader) Detail(_a0 context.Context, _a1 string) (*inovibe_api_v3.DeviceResponse, error) {
...
func (_m *MockReader) List(_a0 context.Context, _a1 inovibe_api_v3.InstallStatus) (*inovibe_api_v3.DeviceListResponse, error) {
	ret := _m.Called(_a0, _a1)
